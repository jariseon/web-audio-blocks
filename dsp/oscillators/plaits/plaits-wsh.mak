...
# usage: emmake make -f plaits-wsh.mak

TARGET = plaits-wsh.js

OSC = ../../oscs/macro-oscillator2
SRC = $(OSC)/eurorack
MANIFEST = $(OSC)/manifest_wsh.json

SOURCES =  $(OSC)/macro-oscillator2.cc
SOURCES += $(SRC)/plaits/dsp/engine/waveshaping_engine.cc
...
CFLAGS  =  -DOSC_WSH -DTEST $(HEADERS) -std=c++11 -Wall -Wno-unknown-attributes
LDFLAGS =  -O2
