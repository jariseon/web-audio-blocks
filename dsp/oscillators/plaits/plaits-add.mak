...
# usage: emmake make -f plaits-add.mak

TARGET = plaits-add.js

OSC = ../../oscs/macro-oscillator2
SRC = $(OSC)/eurorack
MANIFEST = $(OSC)/manifest_add.json

SOURCES =  $(OSC)/macro-oscillator2.cc
SOURCES += $(SRC)/plaits/dsp/engine/additive_engine.cc
...
CFLAGS  =  -DOSC_ADD -DTEST $(HEADERS) -std=c++11 -Wall -Wno-unknown-attributes
LDFLAGS =  -O2
